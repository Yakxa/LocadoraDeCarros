        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AluguelFinalizado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarroAluguel", x => x.AluguelId);
                    table.ForeignKey(
                        name: "FK_CarroAluguel_Carros_CarroId",
                        column: x => x.CarroId,
                        principalTable: "Carros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarroAluguel_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarroAluguel_CarroId",
                table: "CarroAluguel",
                column: "CarroId");

            migrationBuilder.CreateIndex(
                name: "IX_CarroAluguel_UserProfileId",
                table: "CarroAluguel",
